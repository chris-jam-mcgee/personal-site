...
The scope of DevOps varies from company to company, but they can be generally summarize under the umbrella of continuos improvement. At Dust, DevOps was tasked with improving continuous integration and continuos deployment (CI/CD), generating developer tooling to make interacting with cloud resources easier, curating logs, traces, and metrics dashboards to summarize the state of the system, and alerting on critical errors.
