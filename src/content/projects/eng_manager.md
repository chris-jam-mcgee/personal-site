...
- Frontend: React
- Backend: Python, Flask web framework, Swift
...
7. Switched Internet Service providers
8. Audited physical assets, developed a process for patching

## Outcomes

1. With only one swift developer, and a variety of front end dev, the team felt that we were reaching a bottle neck when it came to the mobile app. We produced an MVP and successfully lobbied to cut over to [react native](https://reactnative.dev/). We went on to experience a sharp decrease in the time to implement new features along with better synchronicity between frontend and backend teams.
